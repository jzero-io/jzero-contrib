...
func Test_weaklyDecodeRequest(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "test",
			args: args{
				bodyBytes: []byte(`{"base":{"username":"test10@myibc.net","nickname":"","groupId":"","phone":"1","email":"","password":"043064917508e684c87033314275c923b1df07341cad8bec49a4464389954d893cf778252bf7d740047369a7d0f544f193e0e97db69c83755c71d483978b62df966ACBC745216B44585622F2372D38CEF785786C4295772F08E71C18116D3E65B913C04C2815CA275725","enableDeviceCodeAuth":true,"accessAlgorithm":"SM9","sm2UsernameSource":"1","sm2Cert":""}}`),
				req:       &CreateRequest{},
			},
		},
	}
